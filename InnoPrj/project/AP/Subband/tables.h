...
extern const Word8 vector_dimension[NUM_CATEGORIES];
extern const Word8 number_of_vectors[NUM_CATEGORIES];
/* The last category isn't really coded with scalar quantization. */
extern const Word8 max_bin[NUM_CATEGORIES];
extern const Word16 max_bin_plus_one_inverse[NUM_CATEGORIES];
extern const Word16 int_dead_zone[NUM_CATEGORIES];
extern const Word16 samples_to_rmlt_window[DCT_LENGTH];
extern const Word16 rmlt_to_samples_window[DCT_LENGTH];

/* Add next line in Release 1.2 */
extern const Word8 int_dead_zone_low_bits[NUM_CATEGORIES];
#ifdef SIREN14
extern const Word16 max_samples_to_rmlt_window[MAX_DCT_LENGTH];
extern const Word16 max_rmlt_to_samples_window[MAX_DCT_LENGTH];
#endif
