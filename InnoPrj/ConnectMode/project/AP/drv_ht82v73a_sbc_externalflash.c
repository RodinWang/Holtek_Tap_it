...
u8 gVOICE_Volume = VOLUME_DB_ZERO_INDEX;
...
void BFTM0_IRQHandler(void)
{
  ...
  else
  {
    u16 dwData = PingPongBuffer[CurrentPingPongIndex][BufferIndex];
		...
		DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_R, DISABLE);
    DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_L, DISABLE);  
    DACD16_SetChannelData(HT_DACDUAL16, DAC_CH_R, dwData);    
    DACD16_SetChannelData(HT_DACDUAL16, DAC_CH_L, dwData);
    DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_R, ENABLE);
    DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_L, ENABLE);   
...
void Audio_Init(void)
{
  ...
  NVIC_EnableIRQ(BFTM0_IRQn);
	...
	AFIO_GPxConfig(GPIO_PC, AFIO_PIN_1, AFIO_FUN_DAC);
	AFIO_GPxConfig(GPIO_PC, AFIO_PIN_2, AFIO_FUN_DAC);
...
static void SoftwareMute(void)
{
	DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_R, DISABLE);
  DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_L, DISABLE);  
	DACD16_SetChannelData(HT_DACDUAL16, DAC_CH_R, 0x7FFF);    
	DACD16_SetChannelData(HT_DACDUAL16, DAC_CH_L, 0x7FFF);
	DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_R, ENABLE);
  DACD16_SoftwareStartConvCmd(HT_DACDUAL16, DAC_CH_L, ENABLE);    
}
