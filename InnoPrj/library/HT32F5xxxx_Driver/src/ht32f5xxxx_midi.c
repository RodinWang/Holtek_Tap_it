...
/** @addtogroup HT32F0006_Peripheral_Driver HT32F0006 Peripheral Driver
  * @{
  */
...
/* Global functions ----------------------------------------------------------------------------------------*/
/** @defgroup MIDI_Exported_Functions MIDI exported function prototypes
  * @{
  */
///*********************************************************************************************************//**
...
// * @retval None
// ************************************************************************************************************/
//void MIDI_DeInit(HT_MIDI_TypeDef* MIDIx)
//{
...
//  if (MIDIx == HT_MIDI)
//  {
//	  RSTCU_APBPerip0Reset(RSTCU_APBRST0_MIDI, ENABLE);
//	}
//}
